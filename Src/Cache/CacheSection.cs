...
{
  /// <summary>
  /// Represents a group of <see cref="CacheSetting"/> objects.
  /// </summary>
  public sealed class CacheSection : ConfigurationElement, IEnumerable<CacheSetting>
  {
    /// <summary>
    ...
    /// <summary>
    /// Creates a new instance of the <see cref="CacheSection"/> class that is
    ...
    public static CacheSection FromObject(string name, object obj)
    {
      ...
      var section = new CacheSection(name);
      ...
      foreach (var prop in metadata.Properties)
      {
        ...
        var setting = new CacheSetting(prop.Property.Name);
      ...
      foreach (var field in metadata.Fields)
      {
        ...
        var setting = new CacheSetting(field.Field.Name);
    ...
    private void SetSettingValueFromProperty(PropertyMappingMetadata property, object instance)
    {
      ...
      CacheSetting? setting = FindSetting(property.Property.Name);
      if (setting == null)
      {
        return;
      }
    ...
    private void SetSettingValueFromField(FieldMappingMetadata field, object instance)
    {
      ...
      CacheSetting? setting = FindSetting(field.Field.Name);
      if (setting == null)
      {
        return;
      }
    ...
    /// </summary>
    public IEnumerator<CacheSetting> GetEnumerator() => _settings.GetEnumerator();
    ...
    /// section.</exception>
    public void Add(CacheSetting setting)
    {
      if (setting == null)
      {
    ...
    /// empty.</exception>
    public CacheSetting Add(string settingName) => Add(settingName, string.Empty);
    ...
    /// <exception cref="ArgumentNullException">When <paramref name="settingName"/> is null or
    /// empty.</exception>
    public CacheSetting Add(string settingName, object settingValue)
    {
      var setting = new CacheSetting(settingName, settingValue);
      Add(setting);
    ...
    public bool Remove(CacheSetting setting)
    {
      if (setting == null)
      {
        throw new ArgumentNullException(nameof(setting));
    ...
    public bool Contains(CacheSetting setting) => _settings.Contains(setting);
    ...
    /// range.</exception>
    public CacheSetting this[int index]
    {
      get
      {
    ...
    /// </returns>
    public CacheSetting this[string name]
    {
      get
      {
    ...
    /// The found settings.
    /// </returns>
    public IEnumerable<CacheSetting> GetSettingsNamed(
        string name,
        StringComparison comparison = StringComparison.OrdinalIgnoreCase)
    {
      if (name == null)
      {
        return Enumerable.Empty<CacheSetting>();
      }
    ...
    private CacheSetting? FindSetting(string name)
    {
