...
{
  internal static class CacheConfigurationWriter
  {
    internal static string WriteToString(CacheConfiguration cfg)
    {
    ...
    internal static void WriteToTextWriter(CacheConfiguration cfg, TextWriter writer)
    {
      if (cfg == null)
      {
    ...
    internal static void WriteToStreamTextual(CacheConfiguration cfg, Stream stream, Encoding? encoding)
    {
      if (cfg == null)
      {
        throw new ArgumentNullException(nameof(cfg));
    ...
    internal static void WriteToStreamBinary(CacheConfiguration cfg, Stream stream, BinaryWriter? writer)
    {
      if (cfg == null)
      {
        throw new ArgumentNullException(nameof(cfg));
